...
class ABSInputDataLoaderTest extends BaseInputDataLoaderTest
{
    ...
    {
        parent::setUp();
        $this->cleanupBucketAndFiles('-abs');
    }
    ...
    public function testLoadInputData()
    {
        $storage = new Storage(
            input: new Input(
                ...
                files: new FilesList([
                    ...
                    // todo: https://github.com/keboola/input-mapping/commit/9a9f9d33759f59356c777991238e81f63a0a5c4f
                ]),
            ),
        );
        $fs = new Filesystem();
        ...
        $manifest = json_decode(
            file_get_contents(
                $this->getDataDirPath() . '/in/tables/in.c-docker-demo-testConfig-abs.test.manifest',
            ),
            true,
        );
