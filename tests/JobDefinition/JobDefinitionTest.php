...
class JobDefinitionTest extends TestCase
{
    ...
    {
        yield 'configId set, configVersion null' => [
            'configId' => '123',
            'configVersion' => null,
        ];
    ...
    public function testFailsIfOnlyOneOfConfigIdOrVersionIsSet(
        ?string $configId,
        ?string $configVersion,
    ): void {
        $component = new ComponentSpecification([
        ...
        $this->expectExceptionMessage('configId and configVersion must either both be set or both left empty.');
